package com.maxwellindiajaipur.customprogressbar;
 ...
 */
public class ColorArcProgressBarNew extends View {

    private int mWidth;
    private int mHeight;
    private int diameter = 500;  //直径 //diameter
    private float centerX;  //圆心X坐标 //Center X coordinate
    private float centerY;  //圆心Y坐标 //Center Y coordinate
    ...
    public ColorArcProgressBarNew(Context context) {
        super(context, null);
        initView();
    }

    public ColorArcProgressBarNew(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        initCofig(context, attrs);
        initView();
    }

    public ColorArcProgressBarNew(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        ...
        //弧形的矩阵区域 //Arc-shaped matrix area
        bgRect = new RectF();
        ...
        //当前进度的弧形 //Arc of current progress
    ...
    /**
     * 设置整个圆弧宽度 Set the width of the entire arc
     * @param bgArcWidth
     */
